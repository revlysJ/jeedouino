...
$UserModePins = array(	"not_used" 			=> "Non utilisée",
						"input_binary" 		=> "iEntrée Numérique (Sous-type Jeedom: binaire)",
						"input_numeric"		=> "iEntrée Numérique (Sous-type Jeedom: numérique)",
						"input_string"		=> "iEntrée Numérique (Sous-type Jeedom: autre)",
						"output_other" 		=> "oSortie Numérique (Sous-type Jeedom: défaut) ",
						"output_slider" 	=> "oSortie Numérique (Sous-type Jeedom: curseur) ",
						"output_message" 	=> "oSortie Numérique (Sous-type Jeedom: message) "
						);
...
$ArduinoMODEpins = array(	"not_used" 			=> "Non utilisée",
							...
							"bp_input" 			=> "iEntrée multi-clic avec PULL-DOWN",
							"bp_input_pullup"	=> "iEntrée multi-clic avec PULL-UP ",
						...
						//	"pwm_input" 		=> "iEntrée Numérique Variable (0-255 sur 10s) en PULL-UP",
							...
							"teleinfoTX"		=> "oSortie téléinfo EDF ( pin TX )",
							"SomfyRTS"			=> "Réservée Tests lib SomfyRTS (par Yogui).",
							"Send2LCD"			=> "Envoi d'un message sur LCD16x2",
							"double_pulse_low"	=> "oSortie double click mise à LOW (click) HIGH (pause) LOW (click) ",
							"double_pulse_high"	=> "oSortie double click mise à HIGH (click) LOW (pause) HIGH (click) "
							);
$ArduinoESPanalogPins = array(	"not_used" 			=> __("Non utilisée", __FILE__),
								"switch" 			=> "oInverser la Sortie (SWITCH ON/OFF)",
								"low_relais" 		=> "oSortie mise à LOW (HIGH générée aussi) ",
								"low_pulse" 		=> "oSortie mise à LOW avec temporisation (minuterie) ",
								"high_pulse" 		=> "oSortie mise à HIGH avec temporisation (minuterie) ",
...
$PifaceMODEpinsOUT = array(
							...
							"low_pulse_slide" 	=> "Sortie mise à LOW avec temporisation (minuterie) par slider ",
							"high_pulse_slide"	=> "Sortie mise à HIGH avec temporisation (minuterie) par slider",
							"double_pulse_low"	=> "Sortie double click mise à LOW (click) HIGH (pause) LOW (click) ",
							"double_pulse_high"	=> "Sortie double click mise à HIGH (click) LOW (pause) HIGH (click) "
							);
$PiGPIOpins = array(
					"not_used" 			=> "Non utilisée",
					"input" 			=> "iEntrée Numérique avec PULL-DOWN (binaire)",
